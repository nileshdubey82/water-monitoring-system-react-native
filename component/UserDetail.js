...
export default function Val({route},props) {
  ...
  var mynam=`${user.esp}`;
  const [nileshdubey,setnileshdubey]=React.useState(`${user.esp}`);
  const [nilesh,setnilesh]=React.useState(mynam);
  function ShowDetail1(A) {
  ...
  const [esp, setespid] = React.useState('');
  //
  ...
  return (
    ...
    <Loader loading={loading}/>
        ...
        console.log('close modal');
          ...
          <Text style={styles.text}>{user.espid}</Text>
